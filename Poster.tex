...
\begin{poster}{
 ...
 % Authors
 {R Cody Markelz\textsuperscript{1}, Sayan Mukherjee\textsuperscript{2}, Daniel Runcie\textsuperscript{3}} %\\[1em]
 ...
 {
%  \begin{tabular}{r}
%    \includegraphics[width=0.12\textwidth]{dept_ps_lg_hi-res.png}
%  \end{tabular}
 }
